                    ...
                    <tbody id="document-table-body">
                        @forelse ($documents as $doc)
                            <tr id="doc-row-{{ $doc->id }}" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ asset('storage/' . $doc->file) }}" target="_blank" class="text-indigo-600 hover:underline">
                                        Lihat File
                                    </a>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <div class="flex items-center justify-center space-x-4">
                                        <button class="show-btn font-medium text-green-600 dark:text-green-500 hover:underline" title="Detail" data-id="{{ $doc->id }}">
                                            <i class="bi bi-eye-fill text-base"></i>
                                        </button>
                                        <button class="edit-btn font-medium text-indigo-600 dark:text-indigo-500 hover:underline" title="Edit" data-id="{{ $doc->id }}">
                                            <i class="bi bi-pencil-square text-base"></i>
                                        </button>
                                        <button class="delete-btn font-medium text-red-600 dark:text-red-500 hover:underline" title="Hapus" data-id="{{ $doc->id }}">
