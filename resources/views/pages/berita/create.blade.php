                    ...
                    <div
                        ...
                        <div class="mb-4">
                            ...
                            dark:bg-gray-800 dark:border-gray-600 dark:text-white">
                                    ...
                                    {{-- LOGIKA BARU: Hanya Super Admin yang bisa melihat opsi Published --}}
                            ...
                            @if (Auth::user()->role != 'super_admin')
                                <p class="mt-1 text-xs text-gray-500 italic">Hanya Super Admin yang dapat
                                    mempublikasikan berita.</p>
                            @endif
                        </div>
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                const form = document.querySelector('form[action="{{ route('admin.berita.store') }}"]');
                if (!form) return;
                ...
                form.addEventListener('submit', function(e) {
                    ...
                    const title = formData.get('title') || 'Berita Baru';
