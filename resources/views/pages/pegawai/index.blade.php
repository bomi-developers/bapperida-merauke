<x-layout>
    ...
    <div class="p-6">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold text-black dark:text-white">Data Pegawai</h2>
        ...
        <!-- Search -->
        <div class="mb-4">
            <input type="text" id="search" placeholder="Cari pegawai..."
        ...
        <div
            ...
            <div class="max-w-full overflow-x-auto" id="pegawai-table"></div>
        </div>
    </div>
