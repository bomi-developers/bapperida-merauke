            ...
            <div class="relative">
                <button id="profile-button" class="flex items-center gap-3">
                    ...
                    <img src="https://placehold.co/40x40/7e22ce/ffffff?text={{ $initials }}"
                        alt="{{ Auth::user()->name }}" class="w-[90px] md:w-10 md:h-10 rounded-full">
                    <div class="hidden md:block text-left lg:w-[140px]">
                ...
                <div id="profile-dropdown"
                    ...
                    <a href="{{ route('profile') }}"
                        class="block px-4 py-2 text-lg md:text-md text-gray-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-600 rounded-t-lg">
                        <i class="bi bi-gear"></i> Akun Saya</a>
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                            class="w-full text-left block px-4 py-2 text-lg md:text-md  text-red-500 dark:text-red-400 
