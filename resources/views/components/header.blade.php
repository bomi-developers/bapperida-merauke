      ...
      <div class="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
          ...
          <div class="flex items-center gap-3 2xsm:gap-7">
              <ul class="flex items-center gap-2 2xsm:gap-4">
                  ...
                  <x-partials.drop-notification></x-partials.drop-notification>
                  <!-- Notification Menu Area -->
                  <x-partials.drop-chat></x-partials.drop-chat>
              ...
              <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                  ...
                  <div x-show="dropdownOpen"
                      ...
                      <form method="POST" action="{{ route('logout') }}">
                          @csrf
                          <button type="submit"
                              class="flex items-center gap-3.5 px-6 py-4 text-danger text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
