@forelse ($documents as $doc)
    @php
        $lainnya = json_decode($doc->lainnya, true);
    @endphp
        ...
        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <span class="font-semibold">{{ $doc->judul }}</span><br><span
                        class="font-sm">{{ $doc->created_at->translatedFormat('d F Y') }}</span>
                </div>
            </div>
        </td>
