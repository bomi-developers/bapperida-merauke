...
Route::prefix('riset-inovasi')->name('riset-inovasi.')->group(function () {
    ...
    // API untuk cek email (dengan rate limiting: 10 request per menit)
    Route::get('/api/check-email', [ProposalController::class, 'checkEmail'])->middleware('throttle:10,1');
});
// saran
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/check-password', [RenjaController::class, 'checkPassword'])->name('password.check');
